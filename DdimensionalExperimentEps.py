...
if __name__ == "__main__":
    ...
    x_all,y_all,coeffs = generate_dataset_n(n_data=3000*10, noise=100, p1=0.3, p2=0.7, n_variables=1000, coeffs=[0])
    GenLinCFA_score = []
    ...
    for trials in range(10):
        ...
        GenLinCFA_results = Parallel(n_jobs=10)(delayed(run_GenLinCFA)(x,eps) for eps in [0.4,0.425,0.45,0.475,0.5])
        GenLinCFA_score.append(GenLinCFA_results)
